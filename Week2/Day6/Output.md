...
**Query #5**
    ...
    SELECT MIXED_VALUE ,
    REGEXP_SUBSTR(MIXED_VALUE , '[0-9]{2}') AS EXATCLY_2_DIGITS
    FROM regex_practice;

| MIXED_VALUE | EXATCLY_2_DIGITS |
| ----------- | ---------------- |
| abc123xyz   | 12               |
| test45done  | 45               |
| run9fast    |                  |
